...
<header class="d-flex flex-wrap wow fadeInDown breadcrumb_section_tp breadcrumb_section_tp_on_trning_prgrm" data-wow-delay=".44s">
  <div class="container mb-0">
    <div class="row m-0">
      <div class="col-md-7 mr-auto breadcrumb_title_all">        
        ...
        <h1 class="font-500 text-white mb-4">TRAINING PROGRAM</h1>
...
<section class="training_prgrm_section">
  <div class="container">
    <div class="row m-0">
      <!-- <div class="col-md-12">
        <div class="title_heading_iot_sec d-flex flex-wrap wow fadeInDown animated" data-wow-delay=".2s;" style="visibility: visible; animation-name: fadeInDown;">
          <h1 class="mx-auto d-inline-block position-relative text-center" style="line-height: 1.2;">
            Training
            <b style="font-size: 54px;">Programs</b>
          </h1>
        </div>
      </div> -->
      <div class="col-md-6 mt-5 pt-0 wow fadeInUp" data-wow-delay=".24s">
        <div class="traing_prgrm_01_crd">
          <div class="traing_prgrm_detal">
            ...
            <div class="training_all_txt_detal">
              <h4 class="font-600 position-relative d-inline-block mb-3">Internet of Things Architect</h4>
              <p class="mt-4 font-14 font-400">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiut non
              proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
              <button type="button" class="btn btn-primary m-0 font-15 btn_rad_more_right px-0 wow zoomIn" data-wow-delay=".34s">
                <span>
      ...
      <div class="col-md-6 mt-5 pt-0 wow fadeInUp" data-wow-delay=".24s">
        <div class="traing_prgrm_02_crd">
          <div class="traing_prgrm_detal">
            ...
            <div class="training_all_txt_detal">
              <h4 class="font-600 position-relative d-inline-block mb-3">Internet of Things Security</h4>
              <p class="mt-4 font-14 font-400">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiut non
              proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
              <button type="button" class="btn btn-primary m-0 font-15 btn_rad_more_right px-0 wow zoomIn" data-wow-delay=".34s">
                <span>
