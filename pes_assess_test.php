...
<body>
<nav class="top_fst_nav_info_nav">
  <div class="top_fst_nav_info w-100">
    <div class="container-fluid">
      <div class="contact_container_info_lft w-50 float-left">
        <div class="contact_container_info_lft_01 float-left">
          <a href="#!">
            <span class="material-icons">call</span>
            <span class="text-white">+91 12565-56320</span>
          </a>
        </div>
        <div class="contact_container_info_lft_02 float-left">
          <a href="#!">
            <span class="material-icons">local_post_office</span>
            <span class="text-white">poiesis.elearning@gmail.com</span>
          </a>
        </div>
      </div>
      <div class="login_container_info_rgt w-50 float-right">
        <div class="login_container_info_rgt_04 float-right btn btn-primary mb-0" style="background: #f5cb39; margin-right: -15px;">
          <a href="#!" class="btn_reg_sign_up_right_btn p-0" data-toggle="modal" data-target="#exampleModal" style="text-decoration: none;">
            <!-- <span class="material-icons">local_post_office</span> -->
            <span class="text-dark font-600">Sign Up</span>
          </a>
        </div>
        <div class="login_container_info_rgt_02 float-right">
          <a href="#!" class="btn_reg p-0" data-toggle="modal" data-target="#exampleModal">
            <!-- <span class="material-icons">local_post_office</span> -->
            <span class="text-white">Login Now</span>
          </a>
        </div>
        <div class="login_container_info_rgt_03 float-right">
          <div class="socail_sec d-flex">
            <ul>
              <li>
                <a href="#!">
                  <i class="fab fa-facebook" style="font-size: 16px;" aria-hidden="true"></i>
                </a>
              </li>
              <li>
                <a href="#!">
                  <i class="fab fa-twitter" style="font-size: 16px;" aria-hidden="true"></i>
                </a>
              </li>
              <li>
                <a href="#!">
                  <i class="fab fa-linkedin-in" style="font-size: 16px;" aria-hidden="true"></i>
                </a>
              </li>         
            </ul>
          </div>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light wow fadeInDown" data-wow-delay=".24s">
  <div class="container-fluid">
    <a class="navbar-brand p-0 d-flex flex-wrap" href="index.php">
      <img class="m-auto" src="assets/images/logo_01.png" />
      <img class="on_fixed m-auto" src="assets/images/logo_01_on_fixed.png" />
    </a>
    <!-- <div class="serch_Sec_on_head_nav position-relative">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active">
          <a class="nav-link btn btn-primary m-0 px-3" href="index.php">Home<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link btn btn-primary m-0 px-3" href="about_us.php">About Us</a>
        </li>
        <!-- <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle top_courses_nav_br_drpdwm" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Courses<span class="material-icons">keyboard_arrow_down</span>
          </a>
        ...
        <li class="nav-item">
          <!-- <a class="nav-link btn btn-primary m-0 px-3" href="training_program.php"> Programs</a> -->
        </li>
        <li class="nav-item">
          <a class="nav-link btn btn-primary m-0 px-3" href="training_resourses.php">Resources</a>
        </li>
        <li class="nav-item">
          <a class="nav-link btn btn-primary m-0 px-3" href="training_program.php">Training Programs</a>
        </li>
        <div class="other-buttons ml-3">
          <div class="register_btn">
            ...
            <a href="contact_us.php" class="btn btn-primary btn_cont">
              <span>
...
<header class="d-flex flex-wrap wow fadeInDown breadcrumb_section_tp breadcrumb_section_tp_on_pes_asses" data-wow-delay=".44s">
  <div class="container mb-0">
    <div class="row m-0">
      <div class="col-md-7 mr-auto breadcrumb_title_all">        
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb px-0">
            <li class="breadcrumb-item font-14"><a href="#" class="text-btn font-500 font-15">Home</a></li>
            <li class="breadcrumb-item active text-white font-14 font-400" aria-current="page">
              Pes Assessment Test
            </li>
          </ol>
        </nav>
        <h1 class="font-500 text-white mb-4">PeS ASSESSMENT TEST</h1>
        <p class="text-ddd font-14 font-400 mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
        quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo</p>
      </div>
      <div class="col-md-5">
        <div class="card_of_Selection_tech">
          <h4 class="text-white font-500">Take our 7-day Free Trial</h4>
          <p class="text-ddd">por incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
          quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo</p>
          <div class="select_technology_btn_02 pt-3 pb-0 w-100 d-flex justify-content-start position-relative">            
            <button type="button" class="btn btn-primary choose_tech" data-toggle="modal" data-target="#choose_tech_id">
              <span>
...
<!-- //////// PES SKILL ASSESSMENT TEST ////////// -->

<section class="pes_skill_assess_pg_sec">
  <div class="container">
    <div class="row m-0">
      <div class="col-md-7 wow fadeInLeft animated" data-wow-delay=".14s">
        <div class="title_pes_asses_pg pb-4 border-bottom-gray">
          <h3 class="mb-5 position-relative" style="line-height: 1.2;">
            PeS skill
            <br>
            <b style="font-size: 44px;">Assessment</b>
          </h3>
          <p class="font-14">
        ...
        <div class="mt-4 border-bottom-gray">
          <h5 class="font-600">The assessment is done in three steps, as described below:</h5>
          <ul class="font-14 text-gray pl-3">
            <li class="my-4">
              Technical MCQ based test – Questions in the test are selected from six subdomains of the Internet of Things technology. These subdomains are Embedded Systems, Data Communication, Computer Networking, Cyber Security, Data Science and Machine Learning.
            </li>
            <li class="my-4">
        ...
        <p class="mt-4 font-16 text-dark font-600">
      ...
      <div class="col-md-4 ml-auto mt-5 pt-5 wow fadeInRight animated" data-wow-delay=".14s">
        <div class="pes_asses_mob_img01conatiner position-relative pb-4">
          <img class="m-auto" src="assets/images/pes_asses_mob_img01.png" style="max-width: 100%; filter: drop-shadow(0 4px 10px rgba(0,0,0,.1))">
          <div class="bg_stick_img position-absolute" style="top: -35px; right: -60px; width: auto;">
            <img src="assets/images/bg_shpe_layer01.png">
          </div>
          <div class="bg_stick_img position-absolute" style="bottom: -60px; left: -40px">
            <img src="assets/images/bg_shpe_layer01.png">
          </div>          
        </div>
      </div>
...
<!-- Modal -->
<div class="modal fade choose_tech_mdl" id="choose_tech_id" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header d-inline-block">
        <h4 class="w-100 text-left text-dark font-600">Select Technology</h4>
        <p class="w-100 text-left mb-0 pb-2 font-14 font-400 border-bottom-gray">Select your Technology/Domain to take assessment test.</p>
      </div>
        ...
        <div class="row m-0">
          ...
          <!-- <div class="col-md-3"> -->
            <div class="select_tech_radio_btn w-100 row mx-0 my-3 btn-group btn-group-toggle" data-toggle="buttons">
              ...
              <div class="col-md-4">
                <label class="btn btn-secondary the_custom_radio_btn_chse_tech">
                  <span class="material-icons check_radio_icon">check_circle</span>
                  <div class="the_img_on_rdio_btn my-3 mx-auto">
                    <img src="assets/images/courses/iot_architect.svg">
                  </div>
                  <input type="radio" name="options" id="option1" autocomplete="off" checked> 
                  <h6 class="mt-4 font-600">IOT Architech</h6>
                  <p class="font-13 font-400">
              ...
              <div class="col-md-4">
                <label class="btn btn-secondary the_custom_radio_btn_chse_tech">
                  <span class="material-icons check_radio_icon">check_circle</span>
                  <div class="the_img_on_rdio_btn my-3 mx-auto">
                    <img src="assets/images/courses/iot.svg">
                  </div>
                  <input type="radio" name="options" id="option1" autocomplete="off" checked> 
                  <h6 class="mt-4 font-600">IOT Learning</h6>
                  <p class="font-13 font-400">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit...
                  </p>
                </label>
              ...
              <div class="col-md-4">
                <label class="btn btn-secondary the_custom_radio_btn_chse_tech">
                  <span class="material-icons check_radio_icon">check_circle</span>
                  <div class="the_img_on_rdio_btn my-3 mx-auto">
                    <img src="assets/images/courses/digital_marketing.svg">
                  </div>
                  <input type="radio" name="options" id="option1" autocomplete="off" checked> 
                  <h6 class="mt-4 font-600">Data Structre</h6>
                  <p class="font-13 font-400">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit...
                  </p>
                </label>
          ...
          <!-- </div> -->
            ...
            <div class="col-md-12 mt-0 pt-4 border-top-gray">
              <div class="row m-0">
                <div class="col-md-12 px-0 text-center proced_btn_on_choose_tech">
...
/*$(window).scroll(function(){
    if ($(window).scrollTop() >= 350) {
        $('.select_technology_btn button').addClass('select_technology_btn_fixed');
    }
    else {
        $('.select_technology_btn button').removeClass('select_technology_btn_fixed');
    }
});*/
