...
<header class="d-flex flex-wrap wow fadeInDown breadcrumb_section_tp breadcrumb_section_tp_on_courses" data-wow-delay=".44s">
  <div class="container mb-0">
    <div class="row m-0">
      <div class="col-md-7 mr-auto breadcrumb_title_all">        
        ...
        <h1 class="font-500 text-white mb-4">TRAINING PROGRAMS</h1>
      ...
      <div class="col-md-5">
        <div class="card_of_Selection_tech">
          ...
          <div class="select_technology_btn_02 pt-3 pb-0 w-100 d-flex justify-content-start position-relative">            
            <button type="submit" class="btn btn-primary choose_tech" data-toggle="modal" data-target="#choose_tech_id">
              <span>
...
<section class="all_courses_pg_sec">
  <div class="container">
    <div class="mb-3 pb-3 px-3">
      <h4 class="font-600">Professional Training Programs</h4>
    ...
    <div class="row m-0">
      ...
      <div class="my-3 pt-0 col-md-3 wow fadeInUp" data-wow-delay=".24s">
          ...
          <div class="traing_prgrm_detal">
            ...
            <div class="training_all_txt_detal">
              ...
              <div class="d-flex w-100 py-3">
                <button type="button" onclick="to_courses_detl()" class="btn btn-primary m-0 font-14 btn_rad_more_right px-0 wow zoomIn" data-wow-delay=".34s">
                  <span>
...
<script type="text/javascript">
  ...
  function to_courses_detl() {
    location.replace("courses_details.php")
  }
